...
public class FolderAudioRecyclerViewAdapter  extends RecyclerView.Adapter<FolderAudioRecyclerViewAdapter.ViewHolder> {
    ...
    public FolderAudioRecyclerViewAdapter(Context context, ArrayList<FileItem> fileItems, ArrayList<String> folderPaths) {
    ...
    @NonNull
    @Override
    public FolderAudioRecyclerViewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.folder_item,parent,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull FolderAudioRecyclerViewAdapter.ViewHolder holder, int position) {
